...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText mName, mPhoneText, mEmailText, mPasswordText, mSellnumText;
    TextView mSubmitBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneText = findViewById(R.id.phone_Et);
        mEmailText = findViewById(R.id.email_Et);
        mPasswordText = findViewById(R.id.password_Et);
        mSellnumText = findViewById(R.id.sellnum_Et);
